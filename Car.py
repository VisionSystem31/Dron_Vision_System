...
def main():
    ...
    custom_window_size = (2560, 1440)
    cv2.resizeWindow("frame", *custom_window_size)
    ...
    while True:
        ...
        results = model.track(frame, verbose=True, agnostic_nms=True, persist=True, conf=0.40, imgsz=640)
